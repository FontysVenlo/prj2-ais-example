...
sometimes colloquially called POJOS (Plain Old Java Objects). This will simplify your implementation are a compatible
with the design of the genericmapper and genericdoa projects from PRC2.
